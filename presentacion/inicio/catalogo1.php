...
<div class="container">
  ...
  <div class="card">
    ...
    <div class="card-body">
    <a href=<?php echo "index.php?pid=" . base64_encode("presentacion/inicio/informacion.php") . "&idPelicula=". $f->getPelicula()->getId() . "&idFuncion=". $f->getId() ?>><center><font face="impact" class="card-title text-dark"><h5><?php echo $f->getPelicula()->getNombre()?></h5></font></center></a>
    </div>
  </div>
   					<?php }?>
   					</div>
